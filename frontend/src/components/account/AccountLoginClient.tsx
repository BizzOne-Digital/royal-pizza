    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-cream/50 mt-1">See your past orders and reorder faster.</p>
        </div>
        ...
        <div className="rounded-xl border border-gold/20 bg-white/[0.03] p-6 space-y-4">
          ...
          <p className="text-center text-xs text-cream/50">
            No account yet?{" "}
            <Link href="/account/signup" className="text-gold underline-offset-2 hover:underline">
              Create one
            </Link>
          </p>
        </div>
